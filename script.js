...
// Functie om de naam in te stellen
...
chatForm.addEventListener("submit", function(event) {
    ...
    addTextMessage(messageText, "sent");
    messageInput.value = "";
});
